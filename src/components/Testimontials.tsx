...
export default function Testimonials() {
  ...
  return (
    <div className="min-h-screen bg-[#000000] text-white px-8 py-16 mt-40">
...
Request for feedback
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              ...
              engaging digital solutions that put users first and elevate brands through
              technical excellence and creative design.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {testimonials.map((testimonial, index) => (
            <div
              key={testimonial.id}
              className="bg-[#000000] border border-gray-800 rounded-3xl p-8 hover:border-gray-700 transition-all duration-300 group"
              style={{
