...
export const skills = [
  ...
  { name: "UI / UX", icon: FaProjectDiagram },
  { name: "Styled Components", icon: SiStyledcomponents },
  { name: "CSS & SASS & SCSS", icon: SiCss3 },
  { name: "HTML", icon: SiHtml5 },

  { name: "DEPLOYEMENT & Cloudflare & Nginx", icon: SiCloudflare },

  { name: "Cursor / Claude / AI DEV Tools", icon: SiOpenai },
